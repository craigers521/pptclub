...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--order", nargs="+", help="specify space seperate list of presenters")
    parser.add_argument("-q", "--qr", nargs=1, help="specify URL for QR code generation")
